...
- `limbes-d/` : **D, l’île**. Les cases de B, une île en low poly qui pousse avec chaque dépôt selon une grammaire (famille, espèce, taille, état), le texte lu sur le téléphone pour proposer des sujets, et un archipel. Voir [`limbes-d/README.md`](limbes-d/README.md).
